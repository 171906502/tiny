...
import com.zch.auth.dto.UserDto;
 ...
 * If no credentials are found in the request, null is returned as
...
public class UserAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        return UsernamePasswordAuthenticationToken.unauthenticated(userDto.username(), userDto.passowrd());
    }
}
