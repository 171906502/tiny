...
public class CodeGenerator {
    ...
    private static final String JAVA_PATH = "src/main/java/com/zch/tiny";
    ...
    private static void generateCodeForTable(Configuration cfg, DatabaseMetaData metaData, String tableName) throws SQLException, IOException, TemplateException {
        // 查询表结构
    ...
    private static void generateFile(Configuration cfg, Map<String, Object> data, String templateName, String outputFilePath) throws IOException, TemplateException {
